CREATE OR REPLACE FUNCTION create_new_registry_by_age(
...
BEGIN
    ...
    LOOP
        ...
        FROM AP
        JOIN US ON AP.NUMERO_DE_IDENTIFICACION_DEL_USUARIO_EN_EL_SISTEMA = US.NUMERO_DE_IDENTIFICACION_DEL_USUARIO_EN_EL_SISTEMA
        WHERE AP.DIAGNOSTICO_PRINCIPAL = ANY(diagnosticos_principales)
        AND US.EDAD BETWEEN edad_min AND edad_max
        AND US.UNIDAD_EDAD = unidad_edad;
    END LOOP;
